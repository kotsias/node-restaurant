                                            ...
                                            <div key={cartItem._id} 
                                                ...
                                                <div className="flex w-2/5">
                                                    ...
                                                    <div className="flex flex-col justify-between ml-4 flex-grow">
                                                        <span className="font-bold text-sm">{cartItem.productId.name}</span>
                                                ...
                                                <span className="text-center w-1/5 font-semibold text-sm">${ cartItem.total }.00</span>
                                                <span className="text-center w-1/5 font-semibold text-sm">${ cartItem.total }.00</span>
                                            </div>
                            ...
                            <div id="summary" className="w-1/4 px-8 py-10  flex flex-col justify-between">
                                <div className="">
                                    ...
                                    <div className="flex justify-between mt-10 mb-5">
                                        ...
                                        <span className="font-semibold text-sm">{cart.subTotal} &euro;</span>
                                    </div>
                                </div>
